...
Please have a look at the [C API documentation](https://rawgithub.com/zimmski/tirion/master/clients/c-client/doc/html/tirion_8h.html) or [tirion.h](/clients/c-client/tirion.h) for a complete API overview of Tirion's C client library.
